...
# TODO: surface progress task hyperparameters through experiment config & CLI overrides.
...
# TODO: integrate obstacle masking reward shaping into train.py logging for ablations.
...
# TODO: expose action regularization weight via experiment sweeps.
...
# TODO: benchmark rank-discount variant in multi-agent evaluation loop.
