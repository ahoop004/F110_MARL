...
class RewardSchema(BaseSchema):
    mode: str = "basic"
    alive_bonus: float = 0.0004
    forward_scale: float = 0.0015
    reverse_penalty: float = 0.0015
    lateral_penalty: float = 0.0
    target_distance_scale: float = 0.0006
    target_wall_bonus: float = 0.0
    self_wall_penalty: float = 0.0
    herd_bonus: float = 0.0
    ego_collision_penalty: float = -1.0
    opponent_collision_bonus: float = 0.0
    target_crash_reward: float = 0.5
    herd_position_radius: float = 3.5
    herd_position_slack: float = 1.0
    herd_position_scale: float = 0.0
    herd_angle_scale: float = 0.0
    herd_angle_power: float = 2.0
    slow_speed_threshold: float = 0.5
    slow_speed_penalty: float = -0.00012
    ...
    spin_dwell_steps: int = 5
    spin_step_cap: float = 0.0
    spin_episode_cap: float = 0.0
    spin_grace_steps: int = 20
    spin_alpha: float = 0.2
    dt: float = 0.01
    p2_enabled: bool = False
    p2_d_back: float = 0.6
    p2_lat_offset: float = 0.4
    p2_dist_thresh: float = 0.3
    p2_angle_align_thresh: float = 0.35
    p2_blind_angle: float = 2.356194490192345
    p2_hold_decay: float = 3.0
    p2_distance_scale: float = 1.0
    p2_angle_scale: float = 0.5
    p2_blind_bonus: float = 0.4
    p2_lateral_scale: float = 0.2
    p2_camp_speed_thresh: float = 1.2
    p2_camping_penalty: float = 0.2
    p2_reward_clip: float = 1.0
