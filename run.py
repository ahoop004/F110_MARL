...
_raw_headless = os.environ.get("PYGLET_HEADLESS")
if _raw_headless is None or _raw_headless.strip() == "":
    os.environ["PYGLET_HEADLESS"] = "false" if os.environ.get("DISPLAY") else "true"
else:
    _normalized = _raw_headless.strip().lower()
